	...
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1"
				style="background-image: url(templates/images/slide-01.jpg);">
			...
			<div class="item-slick1"
				style="background-image: url(templates/images/slide-02.jpg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false"
			...
			<div class="item-slick1"
				style="background-image: url(templates/images/slide-03.jpg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false"
		...
		<div class="row">
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					<img src="templates/images/banner-01.jpg" alt="IMG-BANNER"> <a
						href="product.html"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							<span class="block1-name ltext-102 trans-04 p-b-8"> Women
							</span> <span class="block1-info stext-102 trans-04"> Spring 2018
							</span>
						</div>
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="templates/images/banner-02.jpg" alt="IMG-BANNER"> <a
						href="product.html"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="templates/images/banner-03.jpg" alt="IMG-BANNER"> <a
						href="product.html"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
...
<section class="bg0 p-t-23 p-b-140">
	<div class="container">
		...
		<div class="row isotope-grid">
			<c:forEach items="${ listMan}" var="listProduct" varStatus="status">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="templates/images/${listProduct.getProImage()}"
								alt="IMG-PRODUCT" style="width: 300px; height: 400px;"> <a
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 "
								data-toggle="modal"
								data-target="#viewModal${ listProduct.getProId()}"> Quick
								View </a>
							<div class="modal fade" id="viewModal${ listProduct.getProId()}"
								role="dialog" style="z-index: 9999">

								<%@include
									file="/WEB-INF/views/web-client/view-product-moal.jsp"%>
							</div>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a
									href="${pageContext.request.contextPath}/${listProduct.getProId()}"
									class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									${listProduct.getProName()} </a> <span class="stext-105 cl3">
									${listProduct.getProPrice()} </span>
							</div>
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#"
									...
									src="templates/images/icons/icon-heart-01.png" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l"
									src="templates/images/icons/icon-heart-02.png" alt="ICON">
								</a>
							</div>
						</div>
					</div>
			...
			<c:forEach items="${ listWoman}" var="listProduct" varStatus="status">
			...
			<c:forEach items="${ listBag}" var="listProduct" varStatus="status">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item bag">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="templates/images/${listProduct.getProImage()}"
								alt="IMG-PRODUCT" style="width: 300px; height: 400px;"> 
								<a class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 "  data-toggle="modal" data-target="#viewModal${ listProduct.getProId()}">
								Quick View </a>
								<div class="modal fade" id="viewModal${ listProduct.getProId()}" role="dialog" style="z-index: 9999">
								
									<%@include file="/WEB-INF/views/web-client/view-product-moal.jsp"%>
								</div>
						</div>
			...
			<c:forEach items="${ listShoes}" var="listProduct" varStatus="status">
			...
			<c:forEach items="${ listWatchs}" var="listProduct"
				varStatus="status">
